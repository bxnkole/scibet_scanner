 ...
 */
public class ProgSportBasketballScanner extends Scanner {
    ...
    public ProgSportBasketballScanner(Date date, Double threshold) {
        this.date = date;
        this.threshold = threshold;

        this.outFile = new File("progsports-bball-results", threshold + "%-" + simpleDateFormat.format(date) + ".txt");
    }

    public static void main(String[] args) throws ParseException {
        ProgSportBasketballScanner scanner = null;
    ...
    public void scanGames() {
        ...
        driver.navigate().to("http://www.progsport.com/basketball/bsk-predictions-" + format + ".html");
